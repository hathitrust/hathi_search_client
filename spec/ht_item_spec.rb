...
RSpec.describe HTItem do
  let(:solr_item) do
    JSON.parse('{"htid":"uva.x001592955","newly_open":null,"ingest":"20201208","rights":["cc-by-nc-nd-4.0",null],"heldby":["uva"],"collection_code":"uva","enum_pubdate":"1983","enum_pubdate_range":"1980-1989","dig_source":"google"}')
  end
